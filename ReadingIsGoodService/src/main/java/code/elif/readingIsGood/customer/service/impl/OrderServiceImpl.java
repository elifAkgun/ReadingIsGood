...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(OrderRepository orderRepository, BookRepository bookRepository, CustomerRepository customerRepository, Clock clock) {
    ...
    public OrderDTO createOrder(OrderDTO orderDTO) {
        ...
        orderEntity.setDate(LocalDateTime.now(clock));
